...
5.Edit the $HOME/bin/resetswift script
...
if __name__ == '__main__':
    ...
    os.system('cd $HOME/PycharmProjects/swift; sudo pip install -r requirements.txt; sudo python setup.py develop; cd -')
    ...
    os.system('sudo mkdir -p /var/log/swift')
